    ...
    ***************************************************************************** */
    ...
    var Table = /** @class */ (function () {
                    ...
                    if (nextColumn) {
                        ...
                        if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                            if (this.scrollable) {
                                ...
                                var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-body table');
        ...
        Table.prototype.setScrollableItemsWidthOnExpandResize = function (column, newColumnWidth, delta) {
            ...
            var scrollableBody = dom.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-body');
            ...
            var scrollableBodyTable = dom.DomHandler.findSingle(scrollableBody, '.p-datatable-scrollable-body table');
            ...
            if (!this.frozen) {
                ...
                if (frozenView) {
                    if (this.dt.virtualScroll)
                        this.frozenSiblingBody = dom.DomHandler.findSingle(frozenView, '.p-datatabe-virtual-scrollable-body');
                    else
